...
// Usage: node --env-file=.env scripts/publish.js --images "slide1.jpg,slide2.jpg" --caption "..." [--dry-run]
...
async function pollUntilFinished(containerId, accessToken, timeoutMs = 60000, intervalMs = 3000) {
