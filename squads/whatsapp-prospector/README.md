...
```
/whatsapp-prospector:workflows:sheets-instagram-pipeline
```

### Tasks Individuais
```
/whatsapp-prospector:tasks:fetch-sheets-lead           # Buscar proximo lead
/whatsapp-prospector:tasks:enrich-instagram             # Enriquecer dados
/whatsapp-prospector:tasks:detect-checkout-platform     # Detectar plataforma checkout
/whatsapp-prospector:tasks:analyze-and-score            # Analisar e scorer
/whatsapp-prospector:tasks:generate-outreach            # Gerar mensagem
/whatsapp-prospector:tasks:validate-outreach            # Validar mensagem
/whatsapp-prospector:tasks:sync-to-crm                  # Sincronizar CRM
/whatsapp-prospector:tasks:notify-team                  # Notificar Slack
/whatsapp-prospector:tasks:mark-lead-done               # Marcar como processado
```

### Agentes
```
/whatsapp-prospector:agents:prospector-chief            # Atlas - Orquestrador
/whatsapp-prospector:agents:instagram-researcher        # Scout - Pesquisador
/whatsapp-prospector:agents:prospect-analyst            # Minerva - Analista
/whatsapp-prospector:agents:outreach-writer             # Velvet - Copywriter
/whatsapp-prospector:agents:crm-syncer                  # Nexus - CRM/Notificacao
```
...
*WhatsApp Prospector v1.0.0 - AIOS Squad*
