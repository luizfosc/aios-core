...
responsavel_type: script-only
model: none
atomic_layer: Task
elicit: false
execute_first:
  script: "node squads/navigator/scripts/navigator/doctor.js"
  output_format: structured
  description: "100% deterministic — version checks, file existence, schema validation. Zero LLM tokens."
