...
|---|---------|--------|-------------|---------------|---------------|
| 1 | **ensinio** | **Pipeline testado: 77 prospects, 20 HOT** | **ensinio-whatsapp-prospector** | **2026-03-09** | **Phase 2b: resolver telefones Top 10 + outreach** |
...
| # | Projeto | Origem | Status | Proximo Passo |
|---|---------|--------|--------|---------------|
